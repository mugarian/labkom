...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Peminjaman / Kelola Peminjaman /</span> Tambah Peminjaman</h4>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form>
              ...
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Janji Kembali</label>
                <input type="datetime-local" class="form-control" id="basic-default-fullname" />
              </div>
              <div class="mb-3">
