                        ...
                        <form action="/bahanpraktikum" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="organization" class="select2 form-select @error('jenis') is-invalid @enderror"
                                    name="jenis">
                                    <option value="">Pilih Jenis Praktikum</option>
                                    <option value="habis" @selected(old('jenis') == 'habis')>Habis</option>
                                    <option value="tidak habis" @selected(old('jenis') == 'tidak habis')>Tidak Habis</option>
                                </select>
                                @error('jenis')
                                    <div class="invalid-feedback">
                                        {{ $message }}
