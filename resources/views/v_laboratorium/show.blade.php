    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered" id="myTable">
                                ...
                                <tbody class="text-center">
                                    @foreach ($barangpakais as $barangpakai)
                                        <tr>
                                            <td style="width:10%">
                                                @if ($barangpakai->foto)
                                            ...
                                            <td>{{ $barangpakai->kode }}</td>
                                            <td class="text-wrap">
                                                {{ $barangpakai->nama }}
                                            </td>
                                            <td class="text-wrap">{{ $barangpakai->laboratorium->nama }}</td>
                                            <td class="text-wrap">{{ $barangpakai->status }}</td>
        ...
        <div class="row mb-3">
            <div class="col-xl">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Tracking Bahan Praktikum</h5>
                    </div>
                    <div class="card-body pb-2">
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered" id="myTable">
                                ...
                                <tbody class="text-center">
                                    @foreach ($bahanpraktikums as $bahanpraktikum)
                                        <tr>
                                            ...
                                            <td class="text-wrap">{{ $bahanpraktikum->status }}</td>
                                            {{-- <td class="text-wrap">{{ $tracking->laboratorium->nama }}</td> --}}
                                            {{-- <td>
                                                <div class="d-flex justify-content-center">
                                                    <a class="btn btn-outline-success p-1"
                                ...
                                <tbody class="text-center">
                                    @foreach ($bahanjurusans as $bahanjurusan)
                                        <tr>
                                            ...
                                            <td class="text-wrap">{{ $bahanjurusan->status }}</td>
                                            {{-- <td class="text-wrap">{{ $tracking->laboratorium->nama }}</td> --}}
                                            {{-- <td>
                                                <div class="d-flex justify-content-center">
                                                    <a class="btn btn-outline-success p-1"
