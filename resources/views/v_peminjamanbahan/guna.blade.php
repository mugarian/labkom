                        ...
                        <form action="/penggunaan" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('bahan_id') is-invalid @enderror"
                                    id="bahan_id" placeholder="bahan_id" value="{{ old('bahan_id', $bahan->kode) }}"
                                    name="bahan_id" required readonly />
                                @error('bahan_id')
        ...
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @if ($bahan)
                        <div class="mt-4 mb-0">
                            <h5 class="mb-0">Data Bahan</h5>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex align-items-center align-items-sm-center justify-content-center gap-4">
                                @if ($bahan->foto)
                                    <img src="{{ asset('storage') . '/' . $bahan->foto }}" alt="pemakaian-avatar"
                        ...
                        <div class="mb-3">
                            ...
                            <p class="form-control">{{ $bahan->kode }}</p>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="stok">stok Bahan</label>
