...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Barang / Kelola Barang /</span> Tambah Barang</h4>
        ...
        <div class="card-body">
          <div class="mb-3 col-12 mb-0">
            <div class="alert alert-primary">
              <h6 class="alert-heading fw-bold mb-1">Penambahan Data Barang</h6>
              <p class="mb-0">Ketika Form Tambah Data Barang ditambahkan,<br />
