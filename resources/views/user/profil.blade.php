        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="/akun/{{ $user->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex align-items-start align-items-sm-center gap-4 mb-4">
                                @if ($user->gambar)
                                    <img src="{{ asset('/storage/' . auth()->user()->gambar) }}" alt="user-avatar"
                                        class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                                @else
                                    <img src="{{ asset('img') }}/user/{{ rand(1, 2) }}.png" alt="user-avatar"
                                        class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                                @endif
                            ...
                            is-invalid
                        @enderror"
                                            name="gambar" onchange="previewImage()" hidden
                    ...
                    is-invalid
                  @enderror"
                                        type="text" name="nomor_induk" id="nomor_induk"
                          ...
                          is-invalid
                      @enderror"
                                            value="{{ old('no_hp', $user->no_hp) }}" placeholder="811 222 333" />
                                        @error('no_hp')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                      ...
                      @enderror"
                            ...
                            is-invalid
                        @enderror"
                                        placeholder="Hi, Do you have a moment to talk Joe?">{{ old('alamat', $user->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
