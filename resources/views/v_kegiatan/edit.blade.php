...
@section('container')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="/kegiatan" class="text-secondary">kegiatan</a>
                /
                <a href="/kegiatan" class="text-secondary">Kelola kegiatan</a> /</span> Ubah Data Kegiatan</h4>
                    ...
                    <div class="card-body">
                        <form action="/kegiatan/{{ $kegiatan->id }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                is-invalid @enderror"
                                    placeholder="deskripsi" name="deskripsi" required>{{ old('deskripsi', $kegiatan->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('mulai') is-invalid @enderror"
                                    ...
                                    value="{{ old('mulai', $kegiatan->mulai) }}" required />
                                @error('mulai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
