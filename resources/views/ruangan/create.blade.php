...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Ruangan / Kelola Ruangan /</span> Tambah Ruangan</h4>
      ...
      <div class="col-xl">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Ruangan</h5>
            <small class="text-muted float-end"><a href="/ruangan">< Kembali </a></small>
          </div>
          <div class="card-body">
            <form>
                <div class="mb-3">
                    <label class="form-label" for="basic-default-name">Foto Ruangan</label>
                    <div class="">
              ...
              <div class="mb-3">
                  <label class="form-label" for="basic-default-company">Penanggung Jawab</label>
        ...
        <div class="card-body">
          <div class="mb-3 col-12 mb-0">
            <div class="alert alert-primary">
              <h6 class="alert-heading fw-bold mb-1">Penambahan Data Ruangan</h6>
